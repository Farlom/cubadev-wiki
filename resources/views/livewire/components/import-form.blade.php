<div>
    <div class="flex flex-col">
        <div class="flex flex-row gap-5">
            <input
                class="p-2 rounded-2xl border-2 border-white w-48  focus:outline-0 focus:placeholder:text-sm @error('title') border-red-500/50 @enderror placeholder:duration-300"
            ...
            <button
                ...
                wire:click="import" wire:loading.attr="disabled">Скопировать
            </button>
        </div>
        <div>
